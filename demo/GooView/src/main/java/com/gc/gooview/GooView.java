...
import com.gc.gooview.util.EvaluateUtil;
import com.gc.gooview.util.GeometryUtil;
import com.gc.gooview.util.Utils;
...
public class GooView extends View {
    ...
    float mStickRadius = 14f;
    private Path mPath;
    private int mStatusBarHeight;
    private int mFarthestDistance = 100;
